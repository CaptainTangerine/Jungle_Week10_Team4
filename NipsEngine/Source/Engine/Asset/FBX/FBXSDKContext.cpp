...
#if defined(_DEBUG)
#pragma comment(lib, "ThirdParty/FBX SDK/lib/x64/debug/libfbxsdk.lib")
#else
#pragma comment(lib, "ThirdParty/FBX SDK/lib/x64/release/libfbxsdk.lib")
#endif
...
FbxScene* FFBXSDKContext::LoadScene(const FString& FilePath)
{
    if (!Manager)
    {
