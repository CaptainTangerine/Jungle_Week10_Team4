...
private:
    ...
    TMap<const USkeletalMeshComponent*, FMeshBuffer> SkeletalMeshBufferMap;
...
public:
    ...
    FMeshBuffer* GetSkeletalMeshBuffer(const USkeletalMeshComponent* SkeletalMeshComponent);
};
