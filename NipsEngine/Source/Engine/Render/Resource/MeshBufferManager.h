...
private:
    ...
    TMap<const USkeletalMesh*, FMeshBuffer> SkeletalMeshBufferMap;
...
public:
    ...
    FMeshBuffer* GetSkeletalMeshBuffer(const USkeletalMesh* SkeletalMeshAsset, const TArray<FNormalVertex>& SkinnedVertices);
};
